...
- Covered by `tests/Feature/Http/Controllers/TaskControllerTest.php` (401 without auth, 404 for another user's task, list/create scoping) and `tests/Feature/Http/Controllers/Auth/AuthControllerTest.php` (register/logout/me) plus `tests/Feature/Http/Controllers/Auth/LoginControllerTest.php` (login).
